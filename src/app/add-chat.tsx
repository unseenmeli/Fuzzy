...
export default function AddChat() {
  ...
  // Get existing relationships to prevent duplicates
  ...
  const handleInvite = async () => {
    ...
    // Check if trying to create duplicate relationship
    ...
    return (
      <View className="flex-1">
        ...
        <View className="flex-1 justify-center items-center px-8">
          ...
          >
            <Text className="text-white font-semibold">Connect with Code</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
